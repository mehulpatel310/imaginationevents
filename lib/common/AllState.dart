...
class AllState extends StatefulWidget {
  const AllState({super.key});

  @override
  State<AllState> createState() => _AllStateState();
}
...
class _AllStateState extends State<AllState> {
  ...
  Future<List<dynamic>?>? getdata() async {
    Uri url = Uri.parse(UrlResourece.ALLSTATE);
  ...
  void filterEvents(String query) {
    final filtered = _allEvents?.where((event) {
      final category = event["state_name"].toString().toLowerCase();
                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // print('State ID: ${state["state_id"].toString()}');
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => AllCity(
                                GetData: state["state_id"].toString(),
                              ),
                            ),
                          );
                          // print('State ID: ${state["state_id"].toString()}');
