...
class _OrgProfileState extends State<OrgProfile> {
  ...
  var img = UrlResourece.ORG;
  Future<List<dynamic>?> getdata() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var ui = prefs.getString("orgid") ?? "";

    print("orgid = $ui"); // Fixed print statement
    ...
    Uri url = Uri.parse(UrlResourece.ORGPROFILE);
    print("uri = $url");
                      ...
                      child: ListView(
                        children: [
                          ...
                          CircleAvatar(
                            ...
                            child: ClipOval(
                              child: userData["cover_img"] != null
                                  ? Image.network(
                                img + userData["cover_img"].toString(),
                          ...
                          SizedBox(height: 20,),
                          profileDetailRow("Name :", userData["company_name"].toString()),
                          SizedBox(height: 20,),
                          profileDetailRow("Email :", userData["email_id"].toString()),
                          SizedBox(height: 20,),
                          profileDetailRow("Mobile No :", userData["mobile_no"].toString()),
                          SizedBox(height: 20,),
                          // profileDetailRow("City Name :", userData["gender"].toString()),
                          // SizedBox(height: 20,),
