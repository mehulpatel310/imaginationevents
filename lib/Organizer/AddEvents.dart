                              ...
                              child: Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    //       fontSize: 26),
                                    // ),),
                                    // Text("Organizer Id :",style: TextStyle(color: Colors.black),),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          stateData.isNotEmpty
                                            ...
                                            value: state != null && state.toString().isNotEmpty
                                                ? state
                                            ...
                                            onChanged: (val) {
                                              setState(() {
                                                ...
                                                city = null;
                                                filtercityData = cityData.where((c) => c["state_id"] == state).toList();
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          filtercityData.isNotEmpty
                                            ...
                                            value: city != null && city.toString().isNotEmpty
                                                ? city
                                                : null, // Ensures hint text shows when nothing is selected
                                            items: filtercityData.map((value) {
                                              return DropdownMenuItem<String>(
                                                value: value['city_id'],
                                          ...
                                          eventsData.isNotEmpty
                                            ...
                                            items: eventsData.map((value) {
                                              return DropdownMenuItem<String>(
                                                ...
                                                child: Text(value['event_cat_name']),
                                              );
                                            }).toList(),
                                            onChanged: (val) {
                                              setState(() {
                                    ...
                                    SizedBox(height: 20,),
                                    Text("Special Attraction :",style: TextStyle(color: Colors.black),),
                                    TextFormField(
                                      keyboardType: TextInputType.text,
                                      // validator: (val)
                                      // {
                                    ...
                                    Text("Address Line 1 :" ,style: TextStyle(color: Colors.black),),
                                    TextFormField(
                                      keyboardType: TextInputType.text,
                                      // obscureText: true,
                                      // validator: (val)
                                    ...
                                    Text("Address Line 2 :" ,style: TextStyle(color: Colors.black),),
                                    TextFormField(
                                      keyboardType: TextInputType.text,
                                      // obscureText: true,
                                      // validator: (val)
                                    ...
                                    Text("Post Code :" ,style: TextStyle(color: Colors.black),),
                                    TextFormField(
                                    ...
                                    Text("longtitude :" ,style: TextStyle(color: Colors.black),),
                                    TextFormField(
                                      keyboardType: TextInputType.number,
                                      // obscureText: true,
                                      // validator: (val)
                                    ...
                                    Text("Is Aprove :" ,style: TextStyle(color: Colors.black),),
                                    TextFormField(
                                      keyboardType: TextInputType.text,
                                      // obscureText: true,
                                      // validator: (val)
                                    ...
                                    Text("Event Start Date:", style: TextStyle(color: Colors.black)),
                                    ...
                                    Text("Event Start Time:", style: TextStyle(color: Colors.black)),
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        prefixIcon: Icon(Icons.access_time), // Clock icon for time
                                        labelStyle: TextStyle(
                                          color: Colors.purple,
                                          fontWeight: FontWeight.bold,
                                        ),
                                      ...
                                      onTap: () async {
                                        ...
                                        if (pickedTime != null) {
                                          ...
                                          starttime.text = DateFormat('hh:mm a').format(selectedTime); // Format as AM/PM
                                        }
                                      },
                                    ),
                                    ...
                                    Text("Event End Date:", style: TextStyle(color: Colors.black)),
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        prefixIcon: Icon(Icons.calendar_today), // Changed icon to calendar
                                        labelStyle: TextStyle(
                                          color: Colors.purple,
                                          fontWeight: FontWeight.bold,
                                        ),
                                    ...
                                    Text("Event End Time:", style: TextStyle(color: Colors.black)),
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        prefixIcon: Icon(Icons.access_time), // Changed icon to clock
                                        labelStyle: TextStyle(
                                          color: Colors.purple,
                                          fontWeight: FontWeight.bold,
                                        ),
                                    ...
                                    Text("Cover Photo:", style: TextStyle(color: Colors.black)),
                                    (cphoto != null)
                                        ? Image.file(
                                      cphoto!,
                                      width: 100.0,
                                    ...
                                    Text("Photo 1:", style: TextStyle(color: Colors.black)),
                                    (photo1 != null)
                                        ? Image.file(
                                      photo1!,
                                      width: 100.0,
                                    ...
                                    Text("Photo 2:", style: TextStyle(color: Colors.black)),
                                    (photo2 != null)
                                        ? Image.file(
                                      photo2!,
                                      width: 100.0,
                                    ...
                                    Text("Photo 3:", style: TextStyle(color: Colors.black)),
                                    (photo3 != null)
                                        ? Image.file(
                                      photo3!,
                                      width: 100.0,
                                    ...
                                    InkWell(
                                      onTap: ()async{
                                        ...
                                        if(formkey.currentState!.validate())
                                        {
                                          ...
                                          var org = prefs.getString("orgid").toString();
...
// print("eorgid = ${title}");
                                          ...
                                          request.fields['event_cat_id'] = events.toString();
                                          request.fields['special_attraction'] = atrac;
                                          ...
                                          print("eorgid = ${request.fields['org_id']}");
                                          // print("eorgid = ${request.fields['event_cat_id']}");

                                          var stream = http.ByteStream(cphoto!.openRead());
